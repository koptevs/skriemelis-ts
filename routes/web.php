...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/lift-managers/create',
        [LiftManagerController::class, 'create'])->name('lift-managers.create');
    Route::post('/lift-managers', [LiftManagerController::class, 'store'])
         ->name('lift-managers.store');
    Route::get('/lift-managers/{liftManager}',
        [LiftManagerController::class, 'show'])->name('lift-managers.show');
    Route::get('/lift-managers/{liftManager}/edit',
        [LiftManagerController::class, 'edit'])->name('lift-managers.edit');
    Route::patch('/lift-managers/{liftManager}',
        [LiftManagerController::class, 'update'])->name('lift-managers.update');
    ...
    Route::get('/inspections/{inspection}',
        [InspectionController::class, 'show'])->name('inspections.show');
    Route::get('/inspections/{inspection}/edit',
        [InspectionController::class, 'edit'])->name('inspections.edit');
    Route::patch('/inspections/{inspection}',
        [InspectionController::class, 'update'])->name('inspections.update');
    Route::delete('/inspections/{inspection}',
        [InspectionController::class, 'destroy'])->name('inspections.destroy');
