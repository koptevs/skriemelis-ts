...
class InspectionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $this->inspections_2022 = array_filter(
            array_filter($this->inspections_source, fn($key) => substr($key, -2) === '02', ARRAY_FILTER_USE_KEY),
        ...
        $this->inspections_02 = array_merge($this->inspections_2022, $this->inspections_2023, $this->inspections_2024);
...
//            if ($expert === '02' && $lift_manager !== '99') {
            if ($expert === '02') {
                ...
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Olegs Jevstratovs')) {
                    array_push($participants, 1);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Olegs Bogorads')) {
                    array_push($participants, 2);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Andrejs Strīkis')) {
                    array_push($participants, 3);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Dāvis Morozs')) {
                    array_push($participants, 4);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Mārtiņš Gudrītis')) {
                    array_push($participants, 5);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Girts Priževoits')) {
                    array_push($participants, 6);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Toms Eglītis')) {
                    array_push($participants, 7);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Artūrs Stiris')) {
                    array_push($participants, 8);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Jūris Indriksons')) {
                    array_push($participants, 9);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Jevgēnijs Prihodjko')) {
                    array_push($participants, 10);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Viktors Kozlāns')) {
                    array_push($participants, 11);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Dāvis Kauliņš')) {
                    array_push($participants, 12);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Mairis Gobiņš')) {
                    array_push($participants, 13);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Andrējs Brīvulis')) {
                    array_push($participants, 14);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Andrejs Pavličenko')) {
                    array_push($participants, 15);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Kristiāns Lapīņš')) {
                    array_push($participants, 16);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Indulis Siktars')) {
                    array_push($participants, 17);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Alvils Laganovskis')) {
                    array_push($participants, 18);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Marks Kirkins')) {
                    array_push($participants, 19);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Aleksandrs Mihailovs')) {
                    array_push($participants, 20);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Edgars Ošmjanskis')) {
                    array_push($participants, 21);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Vladislavs Truskovskis')) {
                    array_push($participants, 22);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Vadims Plavčenko')) {
                    array_push($participants, 23);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Juris Obrazcovs')) {
                    array_push($participants, 24);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Boris Topasovs')) {
                    array_push($participants, 25);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Aleksejs Kijasovs')) {
                    array_push($participants, 26);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Mārtiņš_RHL')) {
                    array_push($participants, 27);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Artūrs Rieka')) {
                    array_push($participants, 28);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Valerijs Grizāns')) {
                    array_push($participants, 29);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Romans Sibiļevs')) {
                    array_push($participants, 30);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Vladimirs Domanovs')) {
                    array_push($participants, 31);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Viktors Domanovs')) {
                    array_push($participants, 32);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Dmitrijs Brokers')) {
                    array_push($participants, 33);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Eduards Dubro')) {
                    array_push($participants, 34);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Pjotrs Greizmanis')) {
                    array_push($participants, 35);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Dmitrijs Gorskijs')) {
                    array_push($participants, 36);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Olegs Tarasenko')) {
                    array_push($participants, 37);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Andrejs Šilovs')) {
                    array_push($participants, 38);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Nikita Gavriļuks')) {
                    array_push($participants, 39);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Sergejs Prohors')) {
                    array_push($participants, 40);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Jānis Krūmiņš')) {
                    array_push($participants, 41);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Jānis_Liftremonts')) {
                    array_push($participants, 42);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Vladislavs Kukainis')) {
                    array_push($participants, 43);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Artūrs_LIFTS')) {
                    array_push($participants, 44);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Aleksejs_Rīgas_Lifti')) {
                    array_push($participants, 45);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Guntis_Rīgas_Lifti')) {
                    array_push($participants, 46);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Ruslans Kudrjavcevs')) {
                    array_push($participants, 47);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Gennadijs_RHL')) {
                    array_push($participants, 48);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Leonids_RHL')) {
                    array_push($participants, 49);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Haralds_KONE')) {
                    array_push($participants, 50);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Serhii Zhuravljov')) {
                    array_push($participants, 51);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Vladyslav Kuznetsov')) {
                    array_push($participants, 52);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Igors Grigorjevs')) {
                    array_push($participants, 53);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Jurij_Ukr')) {
                    array_push($participants, 54);
                }
                if (str_contains($inspection['parbaude_mehanikis_vards_uzvards'], 'Andrejs Žeļezņakovs')) {
